...
VALUES
('TetraMin Tropical Flakes Fish Food', 'Tetra', 'Food', '/productImages/tetraminflakes.jpg', 5, 7.99, true, 'Feed your tropical fish a balanced diet and keep water cleaner and clearer with Tetra Min Tropical Flakes Fish Food. Tropical fish need a diet with protein and fat for energy and vitamins to prevent disease. Tetra Min Tropical Flakes Fish Food is made with Tetra&apos;s patented ProCare blend of vitamins and Omega-3 fatty acids to boost immunity and protect against stress and disease. And it&apos;s easy to digest and will not leach color, helping to keep water clean and clear.'),
